...
REM Run demo
echo [RUNCFG] case=!CASE! n_seeds=!N_SEEDS! seed0=!SEED0! trim=!TRIM! tool_d=!TOOL_D!
if defined PARTS_CSV (
  echo [RUN] Demo with PARTS_CSV=!PARTS_CSV!
  "%PY%" -m experiments.run_demo --case "!CASE!" --n_seeds !N_SEEDS! --seed0 !SEED0! --trim !TRIM! --tool_d !TOOL_D! --parts_csv "!PARTS_CSV!"
) else (
  echo [RUN] Demo with default sample CSV (data\sample_parts.csv)
  "%PY%" -m experiments.run_demo --case "!CASE!" --n_seeds !N_SEEDS! --seed0 !SEED0! --trim !TRIM! --tool_d !TOOL_D!
)
